  ...
  const addTask = () => {
    if (taskDescription) {
      ...
      toast.current.show({
        severity: "error",
        summary: "Error",
        detail: "Please enter your task first.",
      });
    }
  };
      ...
      <div className="wrapper">
        ...
        <div className="todo-container flex flex-column align-items-center justify-content-center">
          ...
          >
            ...
            <div
              className="flex-col align-items-center justify-content-center px-8"
              style={{ maxHeight: "50dvh", overflow: "scroll" }}
            >
              {taskList.length === 0 && (
                <Card className="task-card justify-content-center">
                  <span style={{ fontSize: "1.5rem", fontFamily: "cursive" }}>
                    No Tasks
                  </span>
                </Card>
              )}
              ...
              {taskList
                ...
                .map((task) => (
                  <div
                    className="flex align-items-center justify-content-center todo-list-div"
                    key={task.id}
                  >
                    <Checkbox
                      inputId={task.id}
                    ...
                    {task.completed === true ? (
                      ...
                      <Card className="task-card" style={{ overflow: "auto" }}>
                        {task.taskDesc}
                      </Card>
                    )}
